...
import com.example.mybottomnavapp.data.model.rickmorty.episodeModel
...
interface ApiCall {
    ...
    @GET(ApiDetails.EPISODE_BY_ID_ENDPOINT)
    suspend fun getEpisodeById(@Path("id") id: Int): episodeModel
}